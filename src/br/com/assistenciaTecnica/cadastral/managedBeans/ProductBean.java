...
public class ProductBean {
	...
	public void insertProduct(){
		try{
			...
			FacesContext.getCurrentInstance().addMessage(null , new FacesMessage("Produto j� existe" + 
	...
	public void removeProduct(Product product){
		try{ 
			...
			FacesContext.getCurrentInstance().addMessage(null,new FacesMessage("Produto n�o pode ser removido" +
			product.getModel()));
